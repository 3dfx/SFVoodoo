...
/*
    ...
    (This class is based on Console.java, a class that supports console-style
    IO in a separate window.  The original Console.java was written in 1996.
    Both versions are for use with my on-line introductory java textbook,
...
public class TextIO {
   ...
   public static char getChar()   { return readChar(); }
