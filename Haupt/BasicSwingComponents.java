...
public class BasicSwingComponents extends javax.swing.JFrame {
    ...
    private javax.swing.JPanel getJFrameContentPane() {
        if (ivjJFrameContentPane == null) {
            ...
            ivjJFrameContentPane.add(getJLabel1(), getJLabel1().getName());
            ivjJFrameContentPane.add(getJPasswordField1(), getJPasswordField1().getName());
            getJFrameContentPane().add(getJToggleButton1(),
                    getJToggleButton1().getName());
            ivjJFrameContentPane.add(getJCheckBox1(), getJCheckBox1().getName());
            getJFrameContentPane().add(getJTextField1(),
                    getJTextField1().getName());
            ivjJFrameContentPane.add(getJButton1(), getJButton1().getName());
            getJFrameContentPane().add(getJTextArea1(),
                    getJTextArea1().getName());
            getJFrameContentPane().add(getJScrollBar1(),
                    getJScrollBar1().getName());
            getJFrameContentPane().add(getJProgressBar1(),
                    getJProgressBar1().getName());
        }
